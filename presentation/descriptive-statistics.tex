...
asr_mode = mode(asr_data)  # Returns [0.0]
        ...
        \item \textbf{Interpretation:} The most frequent value (\SI{0.0}{\perthousand}) indicates potential data quality issues - may represent missing countries with exceptionally low rates requiring validation.
    \end{itemize}
\end{frame}
...
\begin{frame}[fragile]
    \frametitle{Standard Deviation \& Variance: Results}
    \begin{itemize}
        \item \textbf{Implementation:}
        \begin{lstlisting}
...
# 24.60
asr_variance = asr_standard_deviation**2  
# 605.08
        \end{lstlisting}
