...
\begin{frame}
    ...
    \input{tables/breast_cancer_cell_sample.tex}
\end{frame}

\begin{frame}
    \frametitle{Global Cancer Data Preview}
    \input{tables/cancers_global_sample.tex}
\end{frame}

\begin{frame}
    \frametitle{Breast Cancer Statistics by Country Preview (Part 1)}
    \input{tables/breast_country_sample_part1.tex}
    \input{tables/breast_country_sample_part2.tex}
\end{frame}

\begin{frame}
    \frametitle{Breast Cancer Statistics by Country Preview (Part 2)}
    % \input{tables/breast_country_sample_part2.tex}
\end{frame}

\begin{frame}
    \frametitle{Breast Cancer Continent Mortality Data Preview}
    \input{tables/breast_cancer_continent_mortality_sample.tex}
\end{frame}
